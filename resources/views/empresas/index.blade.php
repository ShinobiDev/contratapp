  ...
  <div class="col-md-10  col-lg-10 col-sm-10 ">
    <div class="box box-danger">
      <div class="box-header">
        <a href="{{route('registrar_empresa')}}" class="btn btn-danger pull-right"><i class="fa fa-plus-circle" aria-hidden="true"></i> Crear empresa</a>  
      </div>
      <div lass="box-body">
        <table id="empresas-table" class="table table-striped table-codensed table-hover table-resposive">
                ...
                <tbody>
                  ...
                  @forelse ($empresas as $e)
                     <tr id="row_{{$e->id}}">      
                        <td class="text-green text-center bg-info"><strong><h4>{{strtoupper($e->nombre_empresa)}}</h4></strong></td>
                        <td>
